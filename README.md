...
This repository contains the **NES-LTER pipeline** for Project 2. Equivalent pipelines for the other three sites are maintained in separate repositories.
...
## Trophic Levels & Data Sources

| Trophic Level | Metric | Dataset | Source |
|---|---|---|---|
| Zooplankton | Displacement volume (mL m⁻²) | NOAA EcoMon Plankton Survey | [NCEI: 0187513](https://www.ncei.noaa.gov/access/metadata/landing-page/bin/iso?id=gov.noaa.nodc:0187513) |
| Ichthyoplankton | Larval abundance (ind. 10 m⁻²) | NOAA EcoMon Plankton Survey | [NCEI: 0187513](https://www.ncei.noaa.gov/access/metadata/landing-page/bin/iso?id=gov.noaa.nodc:0187513) |
| Forage fish | Biomass CPUE (kg tow⁻¹) | NOAA NEFSC Bottom Trawl Survey | [InPort: 22560 (Fall)](https://inport.nmfs.noaa.gov/inport/item/22560), [22561 (Spring)](https://inport.nmfs.noaa.gov/inport/item/22561) |

**Forage fish species included:** Atlantic herring (*Clupea harengus*), Atlantic mackerel (*Scomber scombrus*), Atlantic butterfish (*Peprilus spp.*), sand lance (*Ammodytes* spp.)

**Ichthyoplankton species included:** *Clupea harengus*, *Scomber scombrus*, *Peprilus* spp., *Ammodytes* spp.
...
│   ├── trophic_amp_forage_fish.R        # vessel/gear corrections; log transform → running mean → SD → outputs for forage fishes 
├── data/
...
Season-specific ρ_W values used where available (herring, butterfish); combined estimate used otherwise (mackerel, sand lance). No ρ_W correction applied to *Ammodytes dubius* (svspp 734) — no published value.
...
```r
source("R/trophamp_zooplankton.R")
source("R/trophamp_ichthyoplankton.R")
source("R/trophamp_phytoplankton.R")
```
...
### Log transformation
Station-level biomass is log-transformed as:
